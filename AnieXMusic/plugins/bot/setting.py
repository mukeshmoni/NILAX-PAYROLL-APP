...
from AnieXMusic.utils.decorators.admins import ActualAdminCB
from AnieXMusic.utils.decorators.language import language, languageCB
from AnieXMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from AnieXMusic.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


@app.on_message(
    filters.command(["settings", "setting" , "MONIsg"]) & filters.group & ~BANNED_USERS
)
@language
