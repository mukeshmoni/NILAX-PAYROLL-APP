...
from AnieXMusic.utils import AdminRightsCheck
from AnieXMusic.utils.database import is_active_chat, is_nonadmin_chat
from AnieXMusic.utils.decorators.language import languageCB
from AnieXMusic.utils.inline import close_markup, speed_markup
...
@app.on_message(
    filters.command(["vcspeed", "speed", "cslow", "vslow", "playback", "vcplayback"])
    & filters.group
    & ~BANNED_USERS
)
@AdminRightsCheck
