...
@app.on_message(filters.command("purge" , "vpge") & admin_filter)
...
@app.on_message(filters.command("spurge" , "vspge") & admin_filter)
...
@app.on_message(filters.command("del" , "MONIdel") & admin_filter)
