...
from AnieXMusic.utils import extract_user, int_to_alpha
...
from AnieXMusic.utils.decorators import AdminActual, language
from AnieXMusic.utils.inline import close_markup
from config import BANNED_USERS, adminlist


@app.on_message(filters.command("auth" , "MONIauth") & filters.group & ~BANNED_USERS)
@AdminActual
